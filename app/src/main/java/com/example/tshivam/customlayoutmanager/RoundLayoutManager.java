...
public class RoundLayoutManager extends RecyclerView.LayoutManager {

    private static final String TAG = RoundLayoutManager.class.getSimpleName();
    ...
    public RoundLayoutManager(int stepSize) {
        mStepSize = stepSize;
    }

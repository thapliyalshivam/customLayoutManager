...
public class RoundLayoutManager1 extends RecyclerView.LayoutManager {

    private static final String TAG = RoundLayoutManager1.class.getSimpleName();
    ...
    public RoundLayoutManager1(int stepSize) {
        mStepSize = stepSize;
    }
    ...
    private static class SavedState implements Parcelable {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<RoundLayoutManager1.SavedState>() {
            @Override
            public RoundLayoutManager1.SavedState createFromParcel(Parcel source) {
                return new RoundLayoutManager1.SavedState(source);
            }

            @Override
            public RoundLayoutManager1.SavedState[] newArray(int size) {
                return new RoundLayoutManager1.SavedState[size];
            }
        };
